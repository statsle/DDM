...
def main(cfg):
    ...
    eval_loader = []
    eval_loader.append(collate_fn(graphs[:2600]))
    eval_loader.append(collate_fn(graphs[2600: 2600+775]))
    eval_loader.append(collate_fn(graphs[1625:]))
    # eval_loader = GraphDataLoader(graphs, collate_fn=collate_fn, batch_size=2500, shuffle=False)
...
if __name__ == "__main__":
    ...
    output_dir = osp.join(root_dir, 'log-eval-0-linear')
